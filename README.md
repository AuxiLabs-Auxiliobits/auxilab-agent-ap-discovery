# auxilab-agent-ap-discovery

> Agentic AI · AP process mapping and automation candidate scoring from unstructured stakeholder interview transcripts
...
```bash
# Clone the repo
git clone https://github.com/AuxiLabs-Auxiliobits/auxilab-agent-ap-discovery.git
cd auxilab-agent-ap-discovery
